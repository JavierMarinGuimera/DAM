...
public class TestResourceSaver {
    ...
    public static void main(String[] args) throws MalformedURLException, IOException {
        ...
        save("ftp://mirror.vexxhost.com/apache/activemq/apache-nms/1.6.0/Apache.NMS-1.6.0-src.zip",
                saver);
        save("http://mirror.team-cymru.org/ubuntu/indices/override.breezy-backports.extra.main",
                saver);
